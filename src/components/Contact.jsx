        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="flex items-center justify-center gap-6 sm:gap-10">
            ...
            >
              ...
              {/* Icon */}
              <svg className="relative z-10 w-6 h-6 sm:w-8 sm:h-8 text-white group-hover:text-[#38bdf8] transition-all duration-500 transform group-hover:rotate-360 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            >
              ...
              <svg className="relative z-10 w-6 h-6 sm:w-8 sm:h-8 text-white group-hover:text-[#60a5fa] transition-all duration-500 transform group-hover:rotate-360 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <svg className="relative z-10 w-6 h-6 sm:w-8 sm:h-8 text-white group-hover:text-[#c8b98c] transition-all duration-500 transform group-hover:rotate-360 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
