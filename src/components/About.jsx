...
function IntroSection() {
  ...
  return (
    <section className="relative pt-32 pb-12 text-center overflow-hidden" style={{ background: "#020617" }}>
      <div
        ref={ref}
        className={`relative z-10 max-w-4xl mx-auto px-6 transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
      >
        {/* Photo avatar */}
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div ref={ref} className="relative rounded-3xl overflow-hidden bg-black/40 border border-white/50 shadow-[inset_0_20px_50px_rgba(0,0,0,0.8)] py-10 px-4 md:px-10">
          ...
          <div
            className={`absolute right-6 top-1/2 -translate-y-1/2 z-20 pointer-events-none md:hidden transition-opacity duration-700 ${hasScrolled ? "opacity-0" : "opacity-100"
              }`}
          >
  ...
  return (
    <section className="relative py-14 px-6 text-center overflow-hidden" style={{ background: "#0f0b1e" }}>
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div
          ref={ref}
          className={`inline-flex justify-center items-center gap-2 sm:gap-4 p-2 rounded-4xl border border-[rgba(173,216,230,0.4)] transition-all duration-1000 ease-out shadow-2xl ${visible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-12 scale-95"
            }`}
          style={{
